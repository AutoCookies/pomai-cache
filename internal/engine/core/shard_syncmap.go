// File: internal/engine/core/shard_syncmap.go
package core
...
func (s *SyncMapShard) Get(key string) (*Entry, bool) {
...
func (s *SyncMapShard) Set(entry *Entry) (*Entry, int64) {
	key := entry.Key()
...
func (s *SyncMapShard) Delete(key string) (*Entry, bool) {
...
func (s *SyncMapShard) EvictExpired() []*Entry {
