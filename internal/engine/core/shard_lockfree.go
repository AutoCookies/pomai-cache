// File: internal/engine/core/shard_lockfree.go
package core
...
func (s *LockFreeShard) Get(key string) (*Entry, bool) {
	stripe := s.getStripe(key)
...
func (s *LockFreeShard) Set(entry *Entry) (*Entry, int64) {
	key := entry.Key()
...
func (s *LockFreeShard) Delete(key string) (*Entry, bool) {
	stripe := s.getStripe(key)
...
func (s *LockFreeShard) EvictExpired() []*Entry {
...
func (s *LockFreeShard) GetAndTouch(key string) (*Entry, bool) {
	return s.Get(key)
}

func (s *LockFreeShard) GetFast(key string) (*Entry, bool) {
	return s.Get(key)
}

func (s *LockFreeShard) SetFast(entry *Entry) (*Entry, int64) {
	return s.Set(entry)
}
